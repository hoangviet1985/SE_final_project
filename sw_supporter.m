function sw_supporter(block_struct, w_side, ration, step_loc, Theta1, Theta2, epsilon1, epsilon2, Theta1_digit, Theta2_digit)
    global pred_res; 
    ...
    if ~any((pred_res(:, 2) > x-w_side) & (pred_res(:, 3) > y-w_side) &...
        ...
        pred = predict_cnc_t(Theta1, Theta2, epsilon1, epsilon2, d);
        if pred == 1
            pred_digit = predict_digit(Theta1_digit, Theta2_digit, d);
